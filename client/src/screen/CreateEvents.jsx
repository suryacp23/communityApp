...
const CreateEvents = () => {
  ...
  const handleSubmit = (e) => {
    ...
    data.append("Referencement", formData.Referencement);
        ...
        <form onSubmit={handleSubmit} className="flex flex-col h-full w-full ">
          ...
          {step === 2 && (
            <div className="flex flex-col gap-2 md:gap-4 p-0 md:p-6  md:bg-[#1a1a1a] text-[#e0e0e0] rounded-lg shadow-lg">
              ...
              <div className="h-full w-full">
                <div className="h-1/4 w-full md:w-full flex p-1 justify-between items-center">
                  <input
                    type="text"
                ...
                <div className=" h-full w-full flex flex-wrap mt-3">
                  {formData.technical.map((event, index) => (
                    <div key={index} className="flex  p-1 gap-2 ">
                      <span className=" bg-[#1e1c1c]  text-[#f0f0f0] border p-3 gap-1 rounded-full flex justify-between items-center">
                        {event}
                      </span>
                      <button
                        type="button"
                        className="text-[#ff5c5c] opacity-85 p-1 max-w-[20%] rounded-md hover:opacity-100"
                  ...
                  {formData.nonTechnical.map((event, index) => (
                    <div key={index} className="flex justify-between mt-2">
                      <span className=" bg-[#1e1c1c]  text-[#f0f0f0] text-center   border p-1 rounded-full flex max-w-[90%] justify-between items-center">
                        <p className="h-full w-full p-2 max-w-[80%] break-words  text-center">
                          {event}
                        </p>
                        <button
                          type="button"
                          className="text-[#ff5c5c] opacity-85 p-2 rounded-md hover:opacity-100"
          ...
          {step === 3 && (
            <div className="flex flex-col gap-4 text-sm text-[#e0e0e0] ">
              ...
              <div className="p-3 border bg-[#222222] ">
                <div className=" h-1/5 w-4/5 md:w-1/3 justify-between  flex items-center p-1">
                  ...
                  <input
                    ...
                    id="Referencement"
                    onChange={(e) =>
                      handleChangefoods("Referencement", e.target.value)
                    }
                  />
                </div>
              ...
              <div className="p-3 border h-full w-full bg-[#222222] ">
                <div className=" h-1/5 w-3/5 md:w-1/3 flex gap-2 justify-between items-center p-1">
                  <label htmlFor="paid" className="flex text-right ">
                    Paid
                  </label>
                  <input
                    type="checkbox"
                ...
                <div className=" h-1/5 flex gap-2 justify-between  items-center p-1">
                  ...
                  <input
                    ...
                    className=" w-4/5  md:px-3 p-1 md:py-2 lg:py-3 border border-[#333333] rounded-md focus:outline-none focus:ring-2 focus:ring-[#4a90e2] bg-[#222222] text-[#e0e0e0] placeholder-[#888888] "
