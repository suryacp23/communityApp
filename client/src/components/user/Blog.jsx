...
const Blog = ({ blog, i }) => {
	...
	return (
		<div className=" relative bg-slate-700 max-w-[400px]  p-3 rounded-md flex flex-col gap-1 hover:cursor-pointer ">
			<div className="flex justify-between ">
				<h2 className=" font-bold text-md lg:text-lg line-clamp-2 ">
					{blog.title}
				</h2>
				<div>
					<MenuRoot>
						<MenuTrigger
							className="text-lg hover:text-xl  h-6 py-0.5"
							asChild
						>
