...
export const fetchBlogs = async ({ queryKey }) => {
	...
	const { data } = await axios.get(`/api/events?page=${page}&limit=10`);
	return data;
};
...
export const Fetchevent = (eventId) => axios.get(`/api/events/${eventId}`).then((res) => res.data);

//create a new event
export const createEvent = (formData) =>
	axios.post("/api/events", formData, { withCredentials: true }).then((res) => res.data);

//delete event
export const deleteEvent = (eventId) =>
	axios.delete(`/api/events/${eventId}`, { withCredentials: true }).then((res) => res.data);

// Sign up a user
export const SignupData = ({ userName, email, password }) =>
	axios.post("/api/auth/signup", { userName, email, password }).then((res) => res.data);
...
export const updateProfile = (profile) =>
	axios.put("/api/profile", profile, { withCredentials: true }).then((res) => res.data);

// Get the paneldata
export const getPanelData = () =>
	axios.get("/api/profile", { withCredentials: true }).then((res) => res.data);
...
export const createComment = (comment) =>
	axios.post(`/api/comment/create`, comment, { withCredentials: true }).then((res) => res.data);
...
export const checkAttendance = async ({ eventId, decodedText }) => {
	const response = await axios.post(`/api/attendance/scan/${eventId}`, decodedText);
...
export const getGroupJoinRequests = async () => {
	return axios.get(`/api/group/r/request`, { withCredentials: true }).then((res) => res.data);
};
...
export const getGroupByEventId = (eventId) =>
	axios.get(`/api/group/byEvent/${eventId}`, { withCredentials: true }).then((res) => res.data);

export const getAppliedEvents = (eventId) =>
	axios.get(`/api/payment/${eventId}`, { withCredentials: true }).then((res) => res.data);

export const updateEvent = (formData, eventId) =>
	axios.put(`/api/events/${eventId}`, formData, { withCredentials: true }).then((res) => res.data);

export const fetchRoles = () => axios.get("/api/auth/check-role").then((res) => res.data);
